    ...
    <div className="about-container">
      <div className="about-content">
        <div className="about-text">
          ...
          <br />
          <p id="text">
            Hi Everyone, I am <span>Vasanth</span> from{" "}
            <span>Tamil Nadu, India</span>.
            <br />
            I am currently unemployed and looking for a Job.
            <br />I have completed Integrated <span>BSc</span> in{" "}
            <span>Computer Science</span>.
            <br />
            <br />
            Apart from coding, some <span>other activities</span> that I love to
            do!.
          </p>
          <ul>
      ...
      <div className="about-skills">
        <h1 id="skill-text">
          Professional <span>Skillsets</span>
        </h1>
        <div className="langs">
          <span>
            <img src={java} alt="" />
          ...
          <span>
            <img id="tailwind" src={tailwind} alt="" />
          </span>
          <span>
